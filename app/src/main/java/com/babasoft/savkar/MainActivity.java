...
import com.babasoft.savkar.adapter.MainViewListAdapter;
...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayList<CustomerDTO> customers=dataBaseManager.getAllCustomers();
        ...
        adapter=new MainViewListAdapter(customers);
